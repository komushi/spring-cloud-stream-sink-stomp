...
Under plugin/configuration/images/image/build/ modify entryPoint/shell like below.
```
...
<entryPoint>
    <shell>java -jar /maven/spring-cloud-stream-sink-stomp.jar $SCS_OPTS</shell>
</entryPoint>
...
```
...
<entryPoint>
    <exec>
        <arg>java</arg>
        <arg>-jar</arg>
        <arg>/maven/spring-cloud-stream-sink-stomp.jar</arg>
    </exec>
</entryPoint>
...
```
